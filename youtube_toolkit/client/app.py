...
async def echo_message(message: str, transform: Optional[str] = None) -> str:
    ...
    # Use the server from the same environment
    server_command = os.path.join(os.path.dirname(sys.executable), "youtube_toolkit-server")
    
    server_params = StdioServerParameters(
        command=server_command,  # Use the installed script
